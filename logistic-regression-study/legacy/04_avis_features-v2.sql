...
SELECT
  ...
  -- Nouveauté du compte : compte vierge sans statut Local Guide
  ...
  -- E. Métrique de sur-afflux / Raid (Ratio brut et transformation logarithmique)
  ...
  LN(ROUND(SAFE_DIVIDE(cds.n_reviews_same_day, NULLIF(cds.avg_daily_reviews, 0)), 2) + 1) AS log_ratio_pic_journalier_fiche
