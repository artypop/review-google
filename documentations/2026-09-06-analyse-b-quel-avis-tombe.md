...
| Modalité | Effet | Fourchette | Écart net ? |
|---|---:|---:|---|
| 0 à 6 jours | ×0.48 | — | oui |
| 14 à 20 jours | ×0.32 | — | oui |
| 21 à 29 jours | ×0.15 | — | oui |
| 30 jours et plus | ×0.20 | — | oui |
...
| Modalité | Effet | Fourchette | Écart net ? |
|---|---:|---:|---|
| note seule, sans texte | ×0.97 | — | oui |
| 1 à 50 caractères | ×1.10 | — | oui |
| 151 à 400 caractères | ×1.15 | — | oui |
| plus de 400 caractères | ×0.98 | — | oui |
...
| Modalité | Effet | Fourchette | Écart net ? |
|---|---:|---:|---|
| avec réponse du propriétaire | ×0.31 | — | oui |
...
| Modalité | Effet | Fourchette | Écart net ? |
|---|---:|---:|---|
| modifié depuis publication | ×1.92 | — | oui |
...
| Modalité | Effet | Fourchette | Écart net ? |
|---|---:|---:|---|
| aucun niveau | ×1.59 | — | oui |
| niveau 4 ou 5 | ×1.16 | — | oui |
| niveau 6 et plus | ×0.73 | — | oui |
...
| Modalité | Effet | Fourchette | Écart net ? |
|---|---:|---:|---|
| compteur à 0 | ×1.21 | — | oui |
| 1 ou 2 avis | ×1.01 | — | oui |
| 21 à 100 avis | ×0.74 | — | oui |
| plus de 100 avis | ×0.82 | — | oui |
